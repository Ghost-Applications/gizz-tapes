...
val mediaItem = MediaItem.Builder()
    .setUri(
        "https://archive.org/download/kglw2024-09-11.bandcampbootlegger/King Gizzard & The Lizard Wizard - Live at Edgefield Amphiteater- Troutdale- OR (9-11-24)/King Gizzard & The Lizard Wizard - Live at Edgefield Amphiteater, Troutdale, OR (9-11-24) - 01 The Dripping Tap (Live).mp3"
    )
    .setMediaId(
        "King Gizzard & The Lizard Wizard - Live at Edgefield Amphiteater- Troutdale- OR (9-11-24)/King Gizzard & The Lizard Wizard - Live at Edgefield Amphiteater, Troutdale, OR (9-11-24) - 01 The Dripping Tap (Live).mp3"
    )
    .setMediaMetadata(
...
val showingPlayerState = PlayerState.MediaLoaded(
    ...
    artworkUri = "https://kglw.net/i/poster-art-1699403482.jpeg",
